...
public:
  ...
  void setDefault();
  ///set area from string (gridtype:gridspec:gridspec..;x1:y1:x2:y2)
  bool setArea(const std::string& areaString);
  ///set area from string (name=name proj4string="+proj..." rectangle=x1:y1:x2:y2)
  bool setAreaFromString(const std::string& areaString);
  ///set area from setup/log string (name=name proj=gt grid=gridspec:gridspec.. area=x1:y1:x2:y2) obsolete
  bool setAreaFromLog(const std::string& areaString);
  /// get string (gridtype:gridspec:gridspec..;x1:y1:x2:y2)
  std::string toString() const;
  /// get string (name=name proj=gt grid=gridspec:gridspec.. area=x1:y1:x2:y2)
