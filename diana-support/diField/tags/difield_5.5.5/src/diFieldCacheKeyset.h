...
public:
  ...
  void     setKeys(  std::string m, miutil::miTime r, std::string n, std::string l, std::string i, miutil::miTime v);
  void     setModel( std::string m   );
  void     setReference (miutil::miTime r );
  void     setName(  std::string n   );
  void     setLevel( std::string l   );
  void     setIdnum( std::string i   );
  void     setValid( miutil::miTime   v   );
