...
public:
  ...
  InventoryBase(const std::string& id_, const std::string& na, const std::vector<std::string>& va) :
    id(id_),name(na), values(va)
  {
  }
  InventoryBase(const std::string& na, const std::vector<std::string>& va) :
    name(na), values(va)
  {
  }
  ...
  std::vector<std::string> getNumericalSortedValues() const;
  std::vector<std::string> getIntSortedValues() const;
  std::vector<std::string> getLexicalSortedValues() const;
  std::set<long> getSortedNumbers() const;
  bool valueExists(std::string value) const;
...
public:
  ...
  Zaxis(const std::string& id_, const std::string& na, const int vct, const bool p,
      const std::vector<std::string>& le, const std::string& name="", const std::string& verticaltype="") :
    InventoryBase(id_, na, le), vc_type(vct), positive(p), nativeName(name), verticalType(verticaltype)
  {
  }
};
...
public:
  ...
  Taxis(const std::string& id_, const std::string& na, const std::vector<std::string>& va) :
...
public:
  ...
  ExtraAxis(const std::string& id_, const std::string& na, const std::vector<std::string>& va) :
    InventoryBase(id_, na, va)
  {
  }
};
...
/**
 * Vertical cross sections from file
 */
class VCrossSection: public InventoryBase {
public:
  std::string xaxis_name;
  std::string yaxis_name;
  ...
  VCrossSection(const std::string& id_) :
    InventoryBase(id_)
  {
  }
  VCrossSection(const std::string& id_, const std::string& na,
      const std::string& xax, const std::string& yax,
      const std::vector<float>& lons, const std::vector<float>& lats) :
    InventoryBase(id_, na), xaxis_name(xax), yaxis_name(yax), lons(lons), lats(lats)
  {
  }
...
public:
  ...
  std::set<VCrossSection> verticalCrossSections;
...
public:
   ...
   * @return
   */
  miutil::miTime getTimeStamp(const std::string modelname = "",
